...
function NotFoundPage() {
    ...
    return (
        <Box sx={{
            ...
            height: '100vh',
            textShadow: '0px 9.399999618530273px 57.6875px 0px rgba(0, 0, 0, 0.04), 0px 47px 355px 0px rgba(0, 0, 0, 0.07);'
            }}>
        ...
        textShadow:'0px 9.399999618530273px 57.6875px 0px rgba(0, 0, 0, 0.04), 0px 47px 355px 0px rgba(0, 0, 0, 0.07)'}}>
            ...
            <Link to={'/'} style={{color:'inherit', textDecoration:'none'}}> Please go back to the homepage</Link>
</Typography>
        </Box>
    )
